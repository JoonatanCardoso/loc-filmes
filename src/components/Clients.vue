<template>
  <div>
    <ul role="list" class="divide-y divide-gray-100 mx-10">
      <li v-for="person in clients" :key="person.email" class="flex justify-between gap-x-6 py-5">
              ...
              >
                <div class="py-1">
                  <MenuItem v-slot="{ active }">
                    <a
                      @click.prevent="navigateToEditClient(person.id)"
                      href="#"
                      :class="[
                  ...
                  <MenuItem @click="() => deleteClient(index)" v-slot="{ active }">
                    <a
                      href="#"
                      :class="[
...
const clients = ref([])
const localStorageKey = 'editClientId' // Nome da chave no localStorage
...
const navigateToEditClient = (clientId) => {
  localStorage.setItem(localStorageKey, clientId.toString())
