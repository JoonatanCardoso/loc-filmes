        ...
        <div class="flex min-w-0 gap-x-4">
          ...
          <div class="min-w-0 flex-auto">
            ...
            <div v-if="person.isActive !== true" class="mt-1 flex items-center gap-x-1.5">
              ...
              <p class="text-xs leading-5 text-gray-500">Inativo</p>
            </div>
              ...
              >
                <div class="py-1">
                  <MenuItem v-slot="{ active }">
                    <a @click.prevent="navigateToEditUser(person.id)" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Editar</a>
                  </MenuItem>
...
const users = ref([]);
const localStorageKey = 'editUserId'; // Nome da chave no localStorage
...
const navigateToEditUser = (userId) => {
  localStorage.setItem(localStorageKey, userId.toString());
