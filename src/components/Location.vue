      ...
      <ul role="list" class="divide-y divide-gray-100 mx-10">
          ...
          <div class="flex min-w-0 gap-x-4">
              ...
              <div class="min-w-0 flex-auto">
                  <p class="text-sm font-semibold leading-6 text-gray-900">{{ person.film }}</p>
                  <p class="mt-1 truncate text-xs leading-5 text-gray-500">Cliente {{ person.client }}</p>
                  <p class="mt-1 truncate text-xs leading-5 text-gray-500">Vencimento {{ person.date }}</p>
              </div>
